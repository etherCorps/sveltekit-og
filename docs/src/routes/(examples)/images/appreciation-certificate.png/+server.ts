...
const fonts = [
	...
	new CustomFont('TrajanPro-Bold', () => read(TrajanProBold).arrayBuffer(), {
		weight: 400
	}),
	new CustomFont('Neo Sans Pro Regular', () => read(NeoSansProRegular).arrayBuffer(), {
		weight: 400
	})
];
...
export const GET: RequestHandler = async () => {
	return new ImageResponse(
		...
		},
		{
			...
			description:
				'This certificate is given to Michael Anderson for his achievement during the month of August 2024. Hopefully this certificate will be a great motivation.',
